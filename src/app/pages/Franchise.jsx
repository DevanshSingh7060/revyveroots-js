        ...
        <div className="max-w-[820px] mx-auto px-8 lg:px-14">
          ...
          {submitted ? (<motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="text-center py-20" style={{ border: `1px solid ${SAGE}`, background: CREAM_2 }}>
              ...
              <div className="md:col-span-2 mt-4">
                <button type="submit" className="px-10 py-4 tracking-[0.24em] uppercase transition-all duration-300" style={{ fontSize: '11px', background: INK, color: CREAM, border: `1px solid ${INK}`, borderRadius: '1px' }} onMouseEnter={(e) => { e.currentTarget.style.background = SAGE_DARK; e.currentTarget.style.borderColor = SAGE_DARK; }} onMouseLeave={(e) => { e.currentTarget.style.background = INK; e.currentTarget.style.borderColor = INK; }}>
                  Submit Interest
                </button>
              </div>
            </form>)}
